...
/**
 * The report_parentprogressview page for showing behaviour.
 *
...
require_once( dirname( __FILE__ ) . '/classes/output/behaviour_page.php'); // autoloader much?

admin_externalpage_setup('report_parentprogressview_behaviour', '', null, '', array()); // this does access checks
...
$pagetitle = $title;
$url = new moodle_url('/report/parentprogressview/behaviour.php');
$PAGE->set_url($url);
...
// log this event
\report_parentprogressview\event\behaviour_viewed::create()->trigger();
...
// create renderable
$renderable = new report_parentprogressview\output\behaviour_page($USER, $earliest_date, $latest_date);
