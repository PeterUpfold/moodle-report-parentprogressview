...
class document_viewed extends \core\event\base {
	...
	public static function get_name() {
		return get_string('eventdocumentviewed', 'report_parentprogressview');
	}
	 ...
	 */
	 ...
	 public function get_description() {
		return sprintf(get_string('eventdocumentvieweddescription', 'report_parentprogressview'),
			$this->userid,
