...
class attendance_viewed extends \core\event\base {
	...
	public static function get_name() {
		return get_string('eventattendanceviewed', 'report_parentprogressview');
	}
	 ...
	 */
	 ...
	 public function get_description() {
		return sprintf(get_string('eventattendancevieweddescription', 'report_parentprogressview'),
			$this->userid,
