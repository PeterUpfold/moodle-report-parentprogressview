...
/**
 * The report_parentprogressview mobile tab viewed class. Allows us to record when the mobile tab is refreshed.
 *
 * @package report_parentprogressview
 */

class mobile_tab_viewed extends \core\event\base {
	...
	public static function get_name() {
		return get_string('eventmobiletabviewed', 'report_parentprogressview');
	}
	 ...
	 */
	 ...
	 public function get_description() {
		return sprintf(get_string('eventmobiletabvieweddescription', 'report_parentprogressview'), $this->userid);
	 }
