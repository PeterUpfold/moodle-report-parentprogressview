...
/**
 *
 * The report_parentprogressview timetable viewed event. This is logged when an individual timetable is viewed via
 * the mobile app. 
...
class mobile_timetable_viewed extends \core\event\base {
	...
	public static function get_name() {
		return get_string('eventmobiletimetableviewed', 'report_parentprogressview');
	}
	 ...
	 */
	 ...
	 public function get_description() {
		return sprintf(get_string('eventmobiletimetablevieweddescription', 'report_parentprogressview'),
			$this->userid,
